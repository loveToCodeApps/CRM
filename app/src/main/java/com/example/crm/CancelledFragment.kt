...
import com.example.crm.databinding.FragmentCancelledBinding
...
class CancelledFragment : Fragment() {
    ...
    private fun getAdminCancelledActivities() {
        val act_lists = mutableListOf<EditUpcomingActivitiesData>()

        val calender: Calendar = Calendar.getInstance()
        val stringRequest = object : StringRequest(
            Request.Method.POST,  URLs.URL_ACTIVITIES_ADMIN_CANCELLED,
...
//                            binding.activitiesRcv.adapter=adapter
    ...
    private fun getExecutiveCancelledActivities() {
        val act_lists = mutableListOf<EditUpcomingActivitiesData>()

        val calender: Calendar = Calendar.getInstance()
        val stringRequest = object : StringRequest(
            Request.Method.POST, URLs.URL_ACTIVITIES_EXECUTIVE_CANCELLED,
            Response.Listener { response ->
